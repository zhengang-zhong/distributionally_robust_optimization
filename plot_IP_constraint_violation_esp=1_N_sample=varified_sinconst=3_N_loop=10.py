...
if __name__ == "__main__":
    ...
    for i in range(N_sample_range):
        file_path = "/Users/zhengangzhong/Dropbox/PhD/documents/paper_writing/CDC2021/result/inverted_pendulum_experiment_N=var_eps=1/" + str(
            i + 1) + "_x_tra.txt"
        x_tra_temp_list = []
    ...
    violate_perc = [i/(int(vio_range/delta_t)) for i in violate_ave_list]
    plot_tex_setting()
    ...
    fig.savefig("/Users/zhengangzhong/Dropbox/PhD/documents/paper_writing/CDC2021/result/plot8.pdf",
              bbox_inches='tight')
